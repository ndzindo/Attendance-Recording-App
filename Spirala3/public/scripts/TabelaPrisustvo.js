  ...
  function romanize(num) {
   ...
   function tabela(data){
    ...
    for( var d=0; d<predavanja; d++){
       if(d<broj){
       rez+=`<td class="zelena" onclick="posaljiPrisustvo('${podaci.predmet}', ${indeks}, ${data} + 1, ${broj} - 1, ${podaci.prisustva[data*studentL+i].vjezbe})" ></td>`  }
       else{
           rez+=`<td class="crvena" onclick="posaljiPrisustvo('${podaci.predmet}', ${indeks}, ${data} + 1, ${broj} + 1, ${podaci.prisustva[data*studentL+i].vjezbe})" ></td>`
       }
    }
    ...
    for( var d=0; d<vjezbe; d++){
       if(d<broj){
       rez+=`<td class="zelena" onclick="posaljiPrisustvo('${podaci.predmet}', ${indeks}, ${data} + 1, ${podaci.prisustva[data*studentL+i].predavanja}, ${broj} - 1)" ></td>`  }
       else{
           rez+=`<td class="crvena" onclick="posaljiPrisustvo('${podaci.predmet}', ${indeks}, ${data} + 1, ${podaci.prisustva[data*studentL+i].predavanja}, ${broj} + 1)" ></td>`
       }
    }
     rez+="</tr>"
     }
